...
import { Eye, EyeOff, Loader2, MessageSquare, Lock, Mail, User } from 'lucide-react';
  ...
  return (
    <div className='min-h-screen lg:grid-cols-2'>
      ...
      <AuthImagePattern
        ...
        subtitile="Connect with friends, share moments, and stay in touch with your loved ones."
      />
